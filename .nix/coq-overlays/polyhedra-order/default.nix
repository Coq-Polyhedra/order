...
{ lib, mkCoqDerivation, which, coq
  ...
  , mathcomp-ssreflect, mathcomp-finmap, coq-elpi, hierarchy-builder
  , version ? null }:

with lib; mkCoqDerivation {
  pname = "polyhedra-order";
  ## you can configure the domain, owner and repository, the default are:
  # repo = "polyhedra-order";
  # owner = "coq-community";
  # domain = "github.com";
...
## - or its version is overridden (by a branch, PR, url or path) in `.nix/config.nix`.
  ...
  propagatedBuildInputs = [ mathcomp-ssreflect mathcomp-finmap hierarchy-builder ]; ## e.g. `= [ mathcomp coq-elpi ]`
